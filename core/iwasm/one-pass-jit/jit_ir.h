...
typedef struct JitCompContext {
    ...
    /* Points to data that are used by a single pass locally. */
    void *pass_local_data;

    /* The interpreter and total frame sizes of the function produced by
       the pass frontend and used by the pass regalloc. */
    uint32 interp_frame_size;
